...
<%
   MemberDTO mDTO = (MemberDTO)request.getAttribute("mAllConfirmDTO");
...
<%
int total=0;
List<CartDTO> cList = (List<CartDTO>)request.getAttribute("cDTOList");
				...
				<table width="100%" cellspacing="0" cellpadding="0" border="1"
					...
					<tr>
						...
						<td height="35" class="td_default"><input
							...
							maxlength="20" value="${mAllConfirmDTO.username}"></input></td>
					</tr>
					<tr>
						<td height="35" class="td_default">우편번호</td>
						<td height="35" class="td_default"><input
							class="input_default" type="text" id="mpost" size="6"
							maxlength="6" value="${mAllConfirmDTO.post}" readonly></td>
					</tr>
					<tr>
						<td height="35" class="td_default">주 소</td>
						<td height="35" class="td_default"><input
							class="input_default" type="text" id="maddress1" size="100"
							maxlength="200" value="${mAllConfirmDTO.addr1}" readonly></input><br> <input
							class="input_default" type="text" id="maddress2" size="100"
							maxlength="200" value="${mAllConfirmDTO.addr2}" readonly></input></td>
					</tr>
					...
					<tr>
						...
						<td height="35" class="td_default"><input
							...
							maxlength="15" value="${mAllConfirmDTO.phone1}${mAllConfirmDTO.phone2}${mAllConfirmDTO.phone3}"></input>
...
<br> <!-- 다음주소 끝 -->
		...
		<tr>
			<td class="td_default" align="center"><input type='button'
				...
				type="submit" value='결제하기' id="orderAllDone"></td>
		</tr>
