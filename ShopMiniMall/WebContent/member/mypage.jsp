...
<form action="MemberUpdateServlet" method="post">
	...
	도로명주소 : <input type="text" value="<%=addr1 %>" id="sample4_roadAddress" placeholder="도로명주소" name="addr1"><br>
	지번주소 : <input type="text" value="<%=addr2 %>" id="sample4_jibunAddress" placeholder="지번주소" name="addr2"><br>
